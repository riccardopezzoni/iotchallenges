...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bd7458, const void *arg_0xb7bd75f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b888c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a32840), 
int (*key_eq_fn)(void *arg_0xb7a32c88, void *arg_0xb7a32e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79019b8, int arg_0xb7901b10);
static double RandomUniform(void );
...
typedef uint16_t Challenge4C$Read$val_t;
typedef TMilli Challenge4C$MilliTimer$precision_tag;
...
typedef TMilli /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef uint16_t /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void Challenge4C$SplitControl$startDone(error_t error);
#line 138
static void Challenge4C$SplitControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void Challenge4C$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void Challenge4C$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void Challenge4C$Read$readDone(error_t result, Challenge4C$Read$val_t val);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
static void Challenge4C$MilliTimer$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t Challenge4C$SplitControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t Challenge4C$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t Challenge4C$Read$read(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void Challenge4C$MilliTimer$startPeriodic(uint32_t dt);
#line 78
static void Challenge4C$MilliTimer$stop(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t Challenge4C$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool Challenge4C$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 22 "Challenge4C.nc"
uint8_t Challenge4C$last_digit[1000];
uint8_t Challenge4C$recCounter[1000];
uint8_t Challenge4C$counter[1000];
uint8_t Challenge4C$ack_counter[1000];
uint8_t Challenge4C$rec_ack[1000];
message_t Challenge4C$packet[1000];
bool Challenge4C$locked[1000];

static inline void Challenge4C$sendReq(void );
static inline void Challenge4C$sendResp(void );
...
static inline void Challenge4C$Boot$booted(void );





static inline void Challenge4C$SplitControl$startDone(error_t err);
#line 103
static inline void Challenge4C$SplitControl$stopDone(error_t err);




static inline void Challenge4C$MilliTimer$fired(void );
...
static void Challenge4C$AMSend$sendDone(message_t *buf, error_t err);
#line 174
static inline message_t *Challenge4C$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 204
static inline void Challenge4C$Read$readDone(error_t result, uint16_t data);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 18 "FakeSensorP.nc"
static inline error_t /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 18
{
  /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t Challenge4C$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
#line 185
  if (__nesc_ntoh_uint16(rcm->msg_type.nxdata) == 1) {
      ...
      Challenge4C$recCounter[sim_node()] = __nesc_ntoh_uint16(rcm->msg_counter.nxdata);
      Challenge4C$ack_counter[sim_node()]++;
      sim_log_debug(161U, "radio_rec", "Request received with c = %d!\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
      Challenge4C$sendResp();
      return buf;
    }


  if (__nesc_ntoh_uint16(rcm->msg_type.nxdata) == 2) {

      sim_log_debug(162U, "radio_rec", "Response received with c = %d!\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
      return buf;
    }
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76a5ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76a5ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = Challenge4C$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76a5ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76a2178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76a2178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t Challenge4C$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void Challenge4C$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 89
{
  if (err == SUCCESS) {
      ...
      if (TOS_NODE_ID == 1) {
          Challenge4C$MilliTimer$startPeriodic(1000);
          sim_log_debug(152U, "timer", "Timer started!\n");
        }
    }
  else 
#line 96
    {
      ...
      Challenge4C$SplitControl$start();
    }
}
...
#line 113
  Challenge4C$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 103
{
  sim_log_debug(154U, "boot", "Radio stopped!\n");
}
...
#line 138
  Challenge4C$SplitControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76a5108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76a5108, msg, error);
#line 110
}
#line 110
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  Challenge4C$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7541088, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7541088) {
#line 100
    case 0U:
#line 100
      /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7541088, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb785d650){
#line 75
  switch (arg_0xb785d650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb785d650);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t Challenge4C$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t Challenge4C$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * Challenge4C$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 35
{
  ...
  if (Challenge4C$locked[sim_node()]) {
      return;
    }
  else 
#line 48
    {
      my_msg_t *rcm = (my_msg_t *)Challenge4C$Packet$getPayload(&Challenge4C$packet[sim_node()], sizeof(my_msg_t ));

#line 50
      if (rcm == (void *)0) {
          return;
        }
      __nesc_hton_uint16(rcm->msg_counter.nxdata, Challenge4C$counter[sim_node()]);
      __nesc_hton_uint16(rcm->msg_type.nxdata, 1);
      __nesc_hton_uint16(rcm->value.nxdata, (void *)0);


      Challenge4C$PacketAcknowledgements$requestAck(&Challenge4C$packet[sim_node()]);

      if (Challenge4C$AMSend$send(2, &Challenge4C$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(148U, "radio_send", "Request sent with c = %d.\n", Challenge4C$counter[sim_node()]);
          Challenge4C$locked[sim_node()] = TRUE;
        }
      else 
#line 63
        {
          sim_log_error(149U, "radio_send", "Error sending request sent with c = %d.\n", Challenge4C$counter[sim_node()]);
        }
    }
}
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
{
#line 217
  my_msg_t *resp = (my_msg_t *)Challenge4C$Packet$getPayload(&Challenge4C$packet[sim_node()], sizeof(my_msg_t ));

  if (resp == (void *)0) {
      sim_log_error(163U, "radio", "Radio error. Pointer to response not inizialised \n");
      return;
    }
  __nesc_hton_uint16(resp->msg_counter.nxdata, Challenge4C$recCounter[sim_node()]);
  __nesc_hton_uint16(resp->msg_type.nxdata, 2);
  __nesc_hton_uint16(resp->value.nxdata, data);



  if (Challenge4C$locked[sim_node()]) {
      sim_log_error(164U, "radio", "Radio error. Channel locked\n");
      return;
    }
  else 
#line 232
    {
      ...
      if (Challenge4C$AMSend$send(1, &Challenge4C$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(165U, "radio", "Response sent with c = %d and data %d.\n", __nesc_ntoh_uint16(resp->msg_counter.nxdata), __nesc_ntoh_uint16(resp->value.nxdata));
          Challenge4C$locked[sim_node()] = TRUE;
        }
    }
}
...
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  Challenge4C$Read$readDone(result, val);
#line 63
}
#line 63
# 24 "FakeSensorP.nc"
...
#line 24
{
  /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73c2c70){
#line 83
  switch (arg_0xb73c2c70) {
#line 83
    case 0U:
#line 83
      Challenge4C$MilliTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      /*Challenge4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73c2c70);
#line 83
      break;
#line 83
    }
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7541a70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7541a70, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static bool Challenge4C$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void Challenge4C$MilliTimer$stop(void ){
#line 78
...
#line 55
{
  /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*Challenge4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
#line 130
  if (&Challenge4C$packet[sim_node()] == buf) {
      Challenge4C$locked[sim_node()] = FALSE;
    }
  if (err != SUCCESS) {
      sim_log_error(155U, "radio", "Message not sent correctly!\n");
      return;
    }
  else 
#line 136
    {
      ...
      rcm = (my_msg_t *)Challenge4C$Packet$getPayload(&Challenge4C$packet[sim_node()], sizeof(my_msg_t ));
    }
...
#line 141
    {
      if (TOS_NODE_ID == 1) {
          if (Challenge4C$PacketAcknowledgements$wasAcked(buf)) {

              Challenge4C$rec_ack[sim_node()]++;
              sim_log_debug(156U, "radio_ack", "Ack received for request with c = %d. This is the %dº ack received\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata), Challenge4C$rec_ack[sim_node()]);
              if (Challenge4C$rec_ack[sim_node()] == Challenge4C$last_digit[sim_node()] + 1) {
                  sim_log_debug(157U, "timer", "Stopping the timer!\n");
                  Challenge4C$MilliTimer$stop();
                }
            }
          else 
#line 151
            {
              sim_log_debug(158U, "radio_ack", "Ack not received for request with c = %d!\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
            }
        }
      ...
      if (TOS_NODE_ID == 2) {
          if (Challenge4C$PacketAcknowledgements$wasAcked(buf)) {
              ...
              sim_log_debug(159U, "radio_ack", "Ack received for response with c = %d.\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
            }
          else 
#line 160
            {
              sim_log_debug(160U, "radio_ack", "Ack not received for response with c = %d!\n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
            }
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module Challenge4C */
  if (!strcmp(varname, "Challenge4C$last_digit"))
  {
    *addr = (uintptr_t)&Challenge4C$last_digit[__nesc_mote];
    *size = sizeof(Challenge4C$last_digit[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Challenge4C$recCounter"))
  {
    *addr = (uintptr_t)&Challenge4C$recCounter[__nesc_mote];
    *size = sizeof(Challenge4C$recCounter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Challenge4C$counter"))
  {
    *addr = (uintptr_t)&Challenge4C$counter[__nesc_mote];
    *size = sizeof(Challenge4C$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Challenge4C$ack_counter"))
  {
    *addr = (uintptr_t)&Challenge4C$ack_counter[__nesc_mote];
    *size = sizeof(Challenge4C$ack_counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Challenge4C$rec_ack"))
  {
    *addr = (uintptr_t)&Challenge4C$rec_ack[__nesc_mote];
    *size = sizeof(Challenge4C$rec_ack[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Challenge4C$packet"))
  {
    *addr = (uintptr_t)&Challenge4C$packet[__nesc_mote];
    *size = sizeof(Challenge4C$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Challenge4C$locked"))
  {
    *addr = (uintptr_t)&Challenge4C$locked[__nesc_mote];
    *size = sizeof(Challenge4C$locked[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module Challenge4C */
  Challenge4C$last_digit[__nesc_mote] = 7;
  memset((void *)&Challenge4C$recCounter[__nesc_mote], 0, sizeof Challenge4C$recCounter[__nesc_mote]);
  Challenge4C$counter[__nesc_mote] = 0;
  Challenge4C$ack_counter[__nesc_mote] = 0;
  Challenge4C$rec_ack[__nesc_mote] = 0;
  memset((void *)&Challenge4C$packet[__nesc_mote], 0, sizeof Challenge4C$packet[__nesc_mote]);
  memset((void *)&Challenge4C$locked[__nesc_mote], 0, sizeof Challenge4C$locked[__nesc_mote]);
